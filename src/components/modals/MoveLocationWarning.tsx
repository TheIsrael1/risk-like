...
const MoveLocationWarning = ({open, toggle, getResponse}: MoveLocationInterface) => {
  return (
    <GeneralModal
    open={open}
    title='Warning'
